...
if __name__ == '__main__':
	...
	parser.add_argument('--phase', type=int, default=50000, help='number of samples used for each training phases') #origin
	#parser.add_argument('--phase', type=int, default=1000, help='number of samples used for each training phases')
	...
	parser.add_argument('--save_step', default=200, type=int, help='step size for save models')
	#parser.add_argument('--sample_num', default=5000, type=int, help='number of samples for evaluation') #origin
	parser.add_argument('--sample_num', default=200, type=int, help='number of samples for evaluation')
	...
	if args.sched:
		...
		args.batch = {4: 128, 8: 64, 16: 32, 32: 16, 64: 8, 128: 8, 256: 8} # origin
		#args.batch = {4: 64, 8: 32, 16: 16, 32: 8, 64: 4, 128: 4, 256: 4}
